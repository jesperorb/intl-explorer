it("view page", () => {
  ...
  cy.findByRole("combobox", { name: /formatter/i }).should(
    "have.value",
    "DateTimeFormat"
  );
  ...
  cy.firstCodeBlock().should(
    "contain",
    `{ style: "unit", unit: "gram", unitDisplay: "short", }`
  );
  cy.findByRole("textbox", { name: /amount/i })
    .clear()
    .type("13");
