...
<div>
	<p>
		<strong>Intl Explorer</strong> {m.blurbPart1()}
		...
		>. {m.blurbPart2()} <strong><code>Intl</code></strong> {m.blurbPart3()}
	</p>
	<Spacing />
	<p>
		{m.blurbPart4()} <a href="/Playground">The Playground</a> {m.blurbPart5()}
	</p>
	<Spacing />
	<p>
		{m.blurbPart6()} <a
