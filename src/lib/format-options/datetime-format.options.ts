...
export type DateTimeFormatOptionsKeys = keyof Intl.DateTimeFormatOptions | 'fractionalSecondDigits';

export const datetimeFormatOptions = new Map<DateTimeFormatOptionsKeys, FormatOptionsValues>([
