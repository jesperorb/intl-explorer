...
export const numberFormatOptionFactory: Factory<PlaygroundOption<"NumberFormat">> = (overrides = {}) => ({
...
export const dateTimeFormatOptionFactory: Factory<PlaygroundOption<"DateTimeFormat">> = (overrides = {}) => ({
  name: "hour",
  valueType: "number",
  inputType: "text",
  defaultValue: undefined,
...
export const numberFormatSchemaFactory: Factory<PlaygroundSchema<"NumberFormat">> = (overrides = {}) => ({
...
export const eventFactory: Factory<Omit<Event, "target"> & { target: HTMLInputElement | null }> = (overrides = {}) => {
	return {
		...overrides,
